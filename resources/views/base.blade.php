        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    @guest
                        <li class="nav-item ">
                            <a class="nav-link  mr-auto text-white" href="{{ route('auth.login') }}"> <svg
                    ...
                    @auth
                        <li class="nav-item ">
                            ...
                            <form class="nav-item" action="{{ route('auth.logout') }}" method="post">
                                ...
                                <button class="text-danger"> <svg xmlns="http://www.w3.org/2000/svg" width="32"
                                        height="32" fill="currentColor" class="bi bi-person-slash" viewBox="0 0 16 16">
                                        <path
